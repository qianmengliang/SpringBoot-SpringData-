...
<head>
    ...
    <script>
        $(function () {
            $.get("${pageContext.request.contextPath }/customer/findCustomerList.do", function (data) {
                var data1=JSON.parse(data);
                for(var i=0;i<data1.content.length;i++){
                    var option = document.createElement("option");
                    option.value = data1.content[i].cust_id;

                    option.text= data1.content[i].cust_name;
                   document.getElementById("sChannel1").appendChild(option);
...
<FORM id=form1 name=form1
      action="${pageContext.request.contextPath }/linkMan/addLinkMan.do"
      method=post>
            ...
            <TD vAlign=top width="100%" bgColor=#ffffff>
                ...
                <TABLE cellSpacing=0 cellPadding=5 border=0>
                    <tr>
                        <td>所属客户：</td>
                        <td colspan="3">
                            <select name="cust_id" id="sChannel1">
